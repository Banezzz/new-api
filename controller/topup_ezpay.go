...
func RequestEzpayPay(c *gin.Context) {
	...
	topUp := &model.TopUp{
		...
		PaymentProvider: model.PaymentProviderEzpay,
...
func handleEzpayOrderCompleted(c *gin.Context, event *service.EzpayOrderNotifyEvent, payload string) {
	...
	if err := model.CompleteSubscriptionOrder(tradeNo, payload, model.PaymentProviderEzpay, ""); err == nil {
...
func handleEzpayOrderExpired(c *gin.Context, event *service.EzpayOrderNotifyEvent) {
	...
	err := model.ExpireSubscriptionOrder(tradeNo, model.PaymentProviderEzpay)
	if err == nil {
	...
	err = model.UpdatePendingTopUpStatus(tradeNo, model.PaymentProviderEzpay, common.TopUpStatusExpired)
