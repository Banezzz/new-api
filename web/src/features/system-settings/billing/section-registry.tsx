    ...
    build: (settings: BillingSettings) => (
      <PaymentSettingsSection
        ...
        ezpayDefaultValues={{
          ...
          EzpaySecretKey: '',
          EzpayCurrency: settings.EzpayCurrency ?? 'usd',
          EzpayToken: settings.EzpayToken ?? 'usdt',
          EzpayNetwork: settings.EzpayNetwork ?? 'tron',
          EzpayPaymentType: settings.EzpayPaymentType ?? 'GMPAY',
