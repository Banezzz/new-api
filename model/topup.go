...
func RechargeInfini(tradeNo string, callerIp string) (err error) {
	...
	err = DB.Transaction(func(tx *gorm.DB) error {
		...
		if topUp.PaymentProvider != "" && topUp.PaymentProvider != PaymentProviderInfini {
			return ErrPaymentMethodMismatch
		}

		if topUp.PaymentMethod != PaymentMethodInfini {
			return ErrPaymentMethodMismatch
		}
...
func RechargeEzpay(tradeNo string, callerIp string) (err error) {
	...
	err = DB.Transaction(func(tx *gorm.DB) error {
		...
		if topUp.PaymentProvider != "" && topUp.PaymentProvider != PaymentProviderEzpay {
			return ErrPaymentMethodMismatch
		}
